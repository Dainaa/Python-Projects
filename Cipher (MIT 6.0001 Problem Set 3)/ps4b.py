...
class Message(object):
    ...
    def get_valid_words(self):
        ...
        '''
        copied_list = self.valid_words.copy()
        return copied_list
    ...
    def build_shift_dict(self, shift):
        ...
        shift_dict = {} #empty dictionary to store all shift values in
        ...
        for i in range(len(capital_alphabet)):
            ...
            if new_index > 25:
                new_index -= 26
          # print(new_index)
            shift_dict.update({capital_alphabet[i]: capital_alphabet[new_index]})
          
        for i in range(len(lowercase_alphabet)):
            new_index = i+n
            if new_index >25:
                new_index-=26
            shift_dict.update({lowercase_alphabet[i]:lowercase_alphabet[new_index]})
    ...
    def apply_shift(self, shift):
        ...
        '''
        #self = message text
        #shift = number of letters to move forward
        shifted_list = []
        shift_dict = self.build_shift_dict(shift)
        for char in self.message_text:
            if char in shift_dict.keys():
                #if the character appears in the keys
                shifted_list.append(shift_dict[char])
            else:
                shifted_list.append(char)
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        '''       
        possible_messages= {} #Store all possible decryptions
        valid_messages = {} #Store valid decryptions
    ...
    # print(''.join(decrypted_list))
            possible_messages.update({''.join(decrypted_list): 26-i})
...
if __name__ == '__main__':
    ...
    # plt2 = PlaintextMessage('My name is', 12)
    # enplt2 = plt2.get_message_text_encrypted()
    # print('ENCRYPTED MESSAGE:', enplt2)
    ...
    # cpt2 = CiphertextMessage("Yk zmyq ue")
    # print('DECRYPTED MESSAGE:', cpt2.decrypt_message())

    # # TODO: WRITE YOUR TEST CASES HERE

     # TODO: best shift value and unencrypted story 
    encrypted_story = CiphertextMessage(get_story_string())
    decrypted_msg = encrypted_story.decrypt_message()
    print(decrypted_msg)
